...
/**
 * print_hexadecimal -this function prints an unsigned number in hexadecimal form
 * @types: Lists of arguments
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width
...
/**
 * print_hexa_upper -this function prints an unsigned number in upper hexadecimal form
 * @types: Lists of arguments
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width
